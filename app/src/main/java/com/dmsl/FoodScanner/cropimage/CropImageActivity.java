 ...
 * Copyright (C) 2012,2013,2014,2015 ds Wellnitz
 *
...
import com.dmsl.FoodScanner.MainActivity;
...
import com.dmsl.FoodScanner.help.HintDialog;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mImageView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                final long nativePix = getIntent().getLongExtra(MainActivity.EXTRA_NATIVE_PIX, 0);
                final int rotation = getIntent().getIntExtra(MainActivity.EXTRA_ROTATION, 0);
        ...
        Util.startBackgroundJob(this, null, getText(R.string.cropping_image).toString(), new Runnable() {
            public void run() {
                try {
                    ...
                    result.putExtra(MainActivity.EXTRA_NATIVE_PIX, bilinear.getNativePix());
